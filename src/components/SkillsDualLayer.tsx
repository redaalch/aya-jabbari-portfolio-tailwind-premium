  ...
  const capabilities = [
    {
      ...
      desc: "Developing end-to-end full-stack applications with secure backends and responsive interfaces.",
      tools: ["React", "Spring Boot", "Laravel", ".NET"],
      color: "text-[#A35C72]",
      lineBg: "bg-[#A35C72]/25",
      dotBg: "bg-[#A35C72]/45",
    ...
    },
    {
      ...
      desc: "Structuring complex datasets, building ETL workflows, and creating visual business intelligence.",
      tools: ["Power BI", "SQL", "MongoDB", "Talend"],
      color: "text-[#C9849B]",
      lineBg: "bg-[#C9849B]/25",
      dotBg: "bg-[#C9849B]/45",
    ...
    },
    {
      ...
      desc: "Designing deployment workflows, containerized environments, and reliable 'infrastructure as code'.",
      tools: ["Docker", "Terraform", "CI/CD", "Linux"],
      color: "text-[#36172A]",
      lineBg: "bg-[#36172A]/20",
      dotBg: "bg-[#36172A]/35",
    ...
    },
    {
      ...
      desc: "Implementing automated processing, document validation, and applied logic using scripting ecosystems.",
      tools: ["Python", "Document Validation", "Anomaly Detection", "AI Extraction"],
      color: "text-[#8B3A55]",
      lineBg: "bg-[#8B3A55]/25",
      dotBg: "bg-[#8B3A55]/45",
      ...
      {capabilities.map((cap, i) => {
        ...
        return (
          <motion.div
            ...
            className={`group relative flex flex-col lg:grid lg:grid-cols-[1.15fr_100px_1fr] items-start lg:items-center gap-5 px-5 py-4 lg:px-8 lg:py-5 rounded-3xl border border-[#36172A]/5 hover:bg-white hover:shadow-md transition-all duration-500 overflow-hidden ${rowBg} ${cap.hoverBorder}`}
          >
            {/* Layer 1: Outcome */}
            <div className="relative z-10 w-full flex flex-col gap-2">
              <div className="flex items-center gap-4">
                <div
                  className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white shadow-sm border border-[#36172A]/5 ${cap.color} group-hover:scale-105 transition-transform duration-500`}
                >
                  <cap.icon size={20} strokeWidth={2.5} />
                </div>
            ...
            <div className="hidden lg:flex relative z-10 h-full items-center justify-center w-[100px] opacity-40 group-hover:opacity-100 transition-opacity duration-300">
              <span className={`h-px w-10 ${cap.lineBg}`} />
              <span className={`mx-2 h-1.5 w-1.5 rounded-full ${cap.dotBg}`} />
              <span className={`h-px w-10 ${cap.lineBg}`} />
            </div>
